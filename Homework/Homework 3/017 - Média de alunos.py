...
with open("notas.csv") as NotasEmTexto:
    notas = csv.reader(NotasEmTexto)
    print(notas)#Nesse caso fiz notas em texto ser um dicionário. O jeito mais apropriado é que notas em texto fosse um CSV. 
    
for i in range(1,51):
    soma += notas[i] #Soma recebe o valor da nota no indice i
